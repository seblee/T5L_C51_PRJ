...
const modbosCmd_t modbusCmdlib[] = {
  //  en         id         fun     len  timeout      mod    modP     VP  slaveAddr feedback
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x03, 0xc8, MODE_PANP, 0xb800, 0xb82b, 0x017e, PAGE24},
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xb88b, 0xb82b, 0x017e, PAGE24},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xb88b, 0xb82c, 0x017f, PAGE24},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xb88b, 0xb82d, 0x0180, PAGE24},
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PANP, 0xba00, 0xba20, 0x01a1, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x04, 0xc8, MODE_PANP, 0xba00, 0xba21, 0x01cd, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xba80, 0xba20, 0x01a1, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xba81, 0xba21, 0x01cd, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xba82, 0xba22, 0x01ce, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xba83, 0xba23, 0x01cf, PAGE26},
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xba84, 0xba24, 0x01d0, PAGE26},
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x02, 0xc8, MODE_PANP, 0xc700, 0xc721, 0x01a8, PAGE39},
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PANP, 0xc700, 0xc723, 0x01ab, PAGE39},
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xc783, 0xc723, 0x01ab, PAGE39},
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_03H, 0x01, 0xc8, MODE_PANP, 0xcf00, 0xcf24, 0x02c1, PAGE47},
    ...
    {BUS_EN, SLAVE_ID, BUS_FUN_06H, 0x01, 0xc8, MODE_PANP, 0xcf84, 0xcf24, 0x02c1, PAGE47},
...
const dataCheckCmd_t dataCheckLib[] = {
  // en     page  data    back   flag
    ...
    {BUS_EN, PAGE24, 0xb82c, 0xb85c, 0xb88c}, //
    {BUS_EN, PAGE24, 0xb82d, 0xb85d, 0xb88d}, //
