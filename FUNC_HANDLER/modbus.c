...
const modbosCmd_t modbusCmdlib[] = {
    ...
    {MODBUS_EN, SLAVE_ID, MODBUS_READ_03H, 0x03, 0xc8, 0x01, 0x0000, 0xa020, 0x031c, 0x00ff},
    {MODBUS_EN, SLAVE_ID, MODBUS_READ_03H, 0x01, 0xc8, 0x01, 0x0000, 0xa023, 0x0319, 0x00ff},
    {MODBUS_EN, SLAVE_ID, MODBUS_WRITE_06H, 0x01, 0xc8, 0x03, 0xa084, 0xa024, 0x0100, 0x0000},
    {MODBUS_EN, SLAVE_ID, MODBUS_READ_03H, 0x01, 0xc8, 0x01, 0x0000, 0xa025, 0x0104, 0x00ff},
    {MODBUS_EN, SLAVE_ID, MODBUS_READ_03H, 0x03, 0xc8, 0x01, 0x0000, 0xa0a0, 0x011a, 0x00ff},  //暂时 mod1
    {MODBUS_EN, SLAVE_ID, MODBUS_READ_03H, 0x02, 0xc8, 0x01, 0x0000, 0xa0a3, 0x0310, 0x00ff},
