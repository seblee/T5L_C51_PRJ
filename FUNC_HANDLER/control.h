...
#define PASSWORD_PAGE_MAX_EVENT    PASSWORD_PAGEJUMP_45_EVENT
...
#define PASSWORD_FUN_05_EVENT 0xA4F5
#define PASSWORD_FUN_06_EVENT 0xA4F6
#define PASSWORD_FUN_MAX      PASSWORD_FUN_06_EVENT
